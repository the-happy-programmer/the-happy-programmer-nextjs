  ...
  return (
    <div className="border-y border-divider bg-default-50">
      <div className="container flex flex-col py-20">
        <div className="mx-auto flex max-w-xs flex-col items-center gap-y-3 pb-9 pt-20 text-center">
          <Chip
            variant="shadow"
            classNames={{
        ...
        <div className="flex flex-col justify-between pb-32 pt-9 sm:flex-col md:flex-row lg:flex-row xl:flex-row">
          <div className="flex flex-col items-center gap-y-9  md:w-1/2 md:justify-center lg:w-1/2 lg:justify-center xl:w-1/2 xl:justify-center">
            {featuresToSub.map(([title, subtitle, Icon]) => (
              <div
                key={title as string}
                className="group flex flex-row gap-x-5 rounded-xl p-4  hover:bg-content2"
              >
                <Icon className="h-14 w-14 rounded-md bg-content2 p-4 text-default-600 group-hover:bg-content1 group-hover:text-primary" />
