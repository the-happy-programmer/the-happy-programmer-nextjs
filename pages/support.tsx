...
export default function Support({}: {}): JSX.Element {
  ...
  return (
    <div>
      ...
      <div className="mx-auto flex w-96 flex-col items-center gap-y-4 rounded-b-2xl bg-gray-100 p-10">
        {[
          'Early Access',
          'Sub-only Courses',
          'Answer Questions',
          ...
          <div className="flex max-w-sm flex-row bg-blue-50">
            <SvgtoReact
              name="check"
              height={20}
              width={20}
            ...
            />
            <p className="text-left font-light text-gray-900 text-opacity-60 dark:text-gray-50">
              {item}
            </p>
          </div>
        ))}
